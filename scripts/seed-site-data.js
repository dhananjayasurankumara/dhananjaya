...
async function seed() {
    console.log('🌱 Seeding default site data...');
    ...
    try {
        ...
        await db.insert(presenceLinks).values(defaultPlatforms).onConflictDoNothing();
        ...
        await db.insert(technicalSkills).values(defaultTech).onConflictDoNothing();
